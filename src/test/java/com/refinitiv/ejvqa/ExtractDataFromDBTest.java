...
public class ExtractDataFromDBTest {
    ...
    @Parameters({"DBTag","ip_port","databaseName1","username","password","tableNamePath","schemaPattern","extractNum","fileDestPath"})
    public void viewFileGenerationTest(String DBTag,String ip_port,String databaseName1,String username,String password,
        ...
        edfd.extractDataFromDb(DBTag,ip_port,databaseName1,username,password,tableNamePath,schemaPattern,extractNum,fileDestPath);
